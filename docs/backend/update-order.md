...
1. Провериь, что все `product_id` из запроса существуют.
...
4. Обновить запись в `orders` со статусом `created`.
5. Обновить связанные записи в `order_items`.
